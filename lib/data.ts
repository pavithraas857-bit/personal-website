...
export const EXPERIENCES: Tile[] = [
  ...
  },
  {
    ...
    bullets: [
      "Designed a video-based intrusion detection framework; built and benchmarked two novel architectures — ConvLSTM2D + MaxPool3D (~50k params) vs. LRCN (~500k params) — on 20-frame 64×64 clips, achieving 84.21% and 94.74% accuracy respectively.",
      "Deployed the ConvLSTM detector on an NVIDIA Jetson Nano (4GB, 5W mode) for real-time perimeter surveillance, achieving ~7 clips/s throughput at ~150ms latency per 20-frame clip within an 800MB RAM footprint.",
    ],
